...
export class DataBaseService {
  ...
  COURSES = [
    new Course('1', 'Kurs JavaFX', 'Wszystko co musisz wiedzieć o budowaniu aplikacji tesktopowych...'),
    ...
    new Course('4', 'Kurs Angular', 'Twórz niesamowite aplikacje webowe. Poznaj możliwości nowej wersji Angulara...')
  ];
